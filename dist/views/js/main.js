...
var resizePizzas = function(size) { 
  ...
  // Changing the value in the pizza slider
  function changePizzaSlider(size) {
   // Using getElementById for improving performance
   ...
   switch(size) {
    ...
    return;
    default:
    console.log("bug in changePizzaSlider");
  }
}

changePizzaSlider(size);

     // Find pizza elements and changing their widths
     function changePizzaSize(size) {
    // Using getElementsByClassName for improving performance
    var randomPizzaHolder = document.getElementsByClassName("randomPizzaContainer");
    var pizzaHLength = randomPizzaHolder.length;
    var sizes = {
      1: "200px",
      2: "300px",
      3: "400px"
    ...
    var b;
    for (b = 0; b < pizzaHLength; b += 1) {
      randomPizzaHolder[b].style.width = sizes[size];
    }
  }
...
function updatePositions() {
 ...
 // console.log("*** updatePositions variable log***");
 // console.log("i current value --> " + i);
 // console.log("i % 5 modulo value --> " + (i % 5));
 // console.log("document.body.scrollTop value --> " + document.body.scrollTop);
 // console.log("current phase status of the sin function --> " + phase);
